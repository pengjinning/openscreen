...
interface UnsavedChangesDialogProps {
	isOpen: boolean;
	variant?: "close" | "newProject" | "loadProject" | "openSession";
	onSaveAndClose: () => void;
	...
	const detail =
		variant === "newProject"
			...
			: variant === "loadProject"
				...
				: variant === "openSession"
					? td("unsavedChanges.detailOpenRecording")
	...
	const saveLabel =
		variant === "newProject"
			...
			: variant === "loadProject"
				...
				: variant === "openSession"
					? td("unsavedChanges.saveAndOpenRecording")
	...
	const discardLabel =
		variant === "newProject"
			...
			: variant === "loadProject"
				...
				: variant === "openSession"
					? td("unsavedChanges.discardAndOpenRecording")
